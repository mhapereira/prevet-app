...
namespace App\Filament\Resources\MolecularViralResource\RelationManagers;
...
class ResultadoViralRelationManager extends RelationManager
{
    protected static string $relationship = 'ResultadoViral';
